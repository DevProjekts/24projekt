...
def load_gui(app):
    ...
    #Creating a hidden entry field to store the ID of each contactlist
    tk.Entry(app.container, text=app.text_id, width=0) \
        .grid(row=1, column=0)
    #Puting the First name entry field on top of the ID field
    ...
    #Establish and grid a frame for buttons NEW, EDIT, DELETE, CLEAR
    ...
    #Adding contactlist Listbox with scroll bar
